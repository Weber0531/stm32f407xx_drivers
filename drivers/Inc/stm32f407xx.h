...
#define SRAM1_BASEADDR	(0x20000000U) // SRAM1 base address，共 112KB
#define SRAM2_BASEARRD	(0x2001C000U) // SRAM1_BASEADDR + SRAM1 size = 0x20000000 + 112KB(=114688 Bytes = 1C000 Bytes)
#define ROM_BASEADDR	(0x1FFF0000U) // System memory (ROM) base address
#define SRAM			(SRAM1_BASEADDR) // In this microcontroller, SRAM is SRAM1
 ...
 *  TODO: Complete for all other peripherals which will be used in the course
 */
 ...
 *  Compare to number of registers of SPI peripheral of STM32Lx or STM32F0x family of MCUs
